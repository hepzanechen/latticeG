import torch
from . import construct_ginv_central
from .add_leads_blkdiag import add_leads_blkdiag
from .construct_tlc_matrix import construct_tlc_matrix
...
def construct_ginv_total(H_BdG: torch.Tensor, E: torch.Tensor, eta: torch.Tensor, leads_info: list) -> torch.Tensor:
    ...
    Ginv_total_blkdiag = add_leads_blkdiag(Ginv_central, leads_info, E, num_leads)
    ...
    for i in range(num_leads):
        ...
        tLCi = construct_tlc_matrix(lead, Ncentre, NLi)
